...
const highlights = [
  { key: 'experience', value: '3+', label: 'about-me.highlights.experience' },
  { key: 'projects', value: '10+', label: 'about-me.highlights.projects' },
        ...
        >
          ...
          <Box sx={{ flex: 1, textAlign: isMobile ? 'center' : 'left' }}>
            ...
            >
              ...
              />
              <Chip
                label={t('about-me.chips.react-native')}
                size="small"
                sx={{ backgroundColor: '#2196F3', color: 'white' }}
              />
              <Chip
